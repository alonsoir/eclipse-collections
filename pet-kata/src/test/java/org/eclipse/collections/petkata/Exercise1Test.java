...
public class Exercise1Test extends PetDomainForKata
{
    ...
    public void getFirstNamesOfAllPeople()
    {
        ...
        MutableList<String> firstNames = this.people.collect(p-> p.getFirstName());
    ...
    public void getNamesOfMarySmithsPets()
    {
        ...
        // Replace null, with a transformation method on MutableList.
        MutableList<String> names = pets.collect(p->p.getName());
    ...
    public void getPeopleWithoutCats()
    {
        ...
        MutableList<Person> peopleWithoutCats = this.people.reject(p->p.hasPet(PetType.CAT));
        //this.people.select(p->!p.hasPet((PetType.CAT)));
